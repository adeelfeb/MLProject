...
const Header = ({ inputText, currentModel = "CNN" }) => {
  ...
  return (
    ...
    {/* Left-most Section */}
    <div className="flex-1 text-gray-800 font-medium text-left max-w-[33%]">
    ...
    {/* Middle Section */}
    <div className="flex-1 text-gray-800 font-medium text-center truncate max-w-[33%]">
      <span className="text-blue-600">{truncateText(fileName)}</span>
    </div>
  
    {/* Right-most Section */}
    <div className="flex-1 text-gray-800 font-medium text-right max-w-[33%]">
      {fileName !== "No file Selected" ? (
        ...
        <span className="absolute right-2.5 top-2.5 flex items-center space-x-2 text-blue-600">
          <MdDiamond size={20} />
          <span>CNN</span>
        </span>
      )}
